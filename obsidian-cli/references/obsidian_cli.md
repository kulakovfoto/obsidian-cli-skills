...
Anything you can do in Obsidian can be done from the command line. Obsidian CLI even includes [developer commands](https://help.obsidian.md/cli#Developer%20commands) to access developer tools, inspect elements, take screenshots, reload plugins, and more.

Video: [obsidian-cli.mp4](https://publish-01.obsidian.md/access/f786db9fac45774fa4f0d8112e232d67/Attachments/video/obsidian-cli.mp4#t=0.001)

> [!warning] Early access feature
>
> Obsidian CLI requires Obsidian 1.12 or above, which is currently an [early access version](https://help.obsidian.md/early-access) and requires a [Catalyst license](https://help.obsidian.md/catalyst). Commands and syntax are likely to change during the early access phase.
...
Commands related to [Properties](https://help.obsidian.md/properties).
...
- Make sure you are using the latest [Obsidian installer version](https://help.obsidian.md/updates) (1.11.7) and the latest [early access version](https://help.obsidian.md/early-access) (1.12).
...
To get this file, go to the official Obsidian Discord in the `#insider-desktop-release` channel. Requires a [Catalyst license](https://help.obsidian.md/catalyst).
